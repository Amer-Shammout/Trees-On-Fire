 ...
 * @author dell
 */
public class HomePageDM extends javax.swing.JFrame {

    /**
     * Creates new form HomePageDM
     */
    public HomePageDM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/problem_2/WelcomeDM.png"))); // NOI18N
        jPanel2.add(jLabel3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomePageDM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomePageDM().setVisible(true);
            }
        });
    }
